...
[`quality-gates`](../quality-gates/SKILL.md). Care about *scope* — keeping a diff small and
verifying it actually works, rather than blocking destructive commands —
[`engineering-discipline`](../engineering-discipline/SKILL.md).
